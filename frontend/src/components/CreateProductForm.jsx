		...
		>
			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				...
				<div className='mt-1 flex items-center'>
					...
					<label
						htmlFor='image'
						className='cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md text-sm text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 flex items-center'
					>
						<Upload className='h-5 w-5 mr-2' />
						Upload Image
					</label>
					{newProduct.image && <img src={newProduct.image} alt='Preview' className='ml-4 h-12 w-12 object-cover rounded' />}
				</div>
